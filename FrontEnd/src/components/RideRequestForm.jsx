...
import styles from "../styles/RideRequestForm.module.css";
import LocationSearch from "./LocationSearch"; // Import LocationSearch
import ErrorMessage from "./ErrorMessage";
import { requestRide } from "../utils/api";  //Centralize API calls
...
function RideRequestForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await requestRide(requestData);  //Use centralized API call
